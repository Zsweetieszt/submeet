    ...
    <div class="email-wrapper">
        <div class="email-content">
            ...
            <div style="border: 1px solid #e8e5ef; border-radius: 6px; padding: 20px; background-color: #f9fafb;">
                ...
                <p><strong>Payment Purpose:</strong> {{ $conference_short_name }} {{ $conference_year }} Conference International {{ $role }} Fee ({{ $attendance_mode }})</p>
                <p><strong>Payment Recipient:</strong></p>
