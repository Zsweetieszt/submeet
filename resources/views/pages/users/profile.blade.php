...
@section('title', 'Edit Profile - ' . Auth::user()->family_name . ' ' . Auth::user()->given_name)

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a>
    </li>
    <li class="breadcrumb-item active"><span>Edit Profile</span>
    </li>
@endsection
        ...
        <div class="card mb-4">
            ...
            <div class="">
                <div class="card-body px-4">
                    <form class="needs-validation" novalidate action="{{ route('users.update-profile', $user->username) }}"
                        ...
                        <div class="row">
                            <fieldset class="a">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control" name="username" type="text" placeholder="Username"
                                        value="{{ old('username', $user->username) }}" hidden>
                                    @error('username')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <fieldset class="mb-4">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="phone_1_country_code" id="phone_1_country_code" style="max-width: 110px;">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="phone_2_country_code" id="phone_2_country_code" style="max-width: 110px;">
                                        <option value="" selected disabled>Select Country Code</option>
                                        @foreach ($countries as $country)
                                            <option data-label="{{ $country->country_name . ' +' . $country->phonecode }}"
                                                value="{{ $country->phonecode }}"
                                ...
                                @php
                                    $hasAccessReviewer = Auth::user()
                                        ...
                                        ->whereHas('event', function ($q) use ($event) {
                                            $q->where('event_code', $event);
                                        })
                                        ->exists();
                                @endphp
                                @if ($hasAccessReviewer && $event)
                                    <fieldset class="mb-4">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (inputExpertise) {
                new Tagify(inputExpertise, {
                    whitelist: [
                        @if (isset($expertises) && $expertises)
